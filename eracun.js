...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (nap1, polja, datoteke) {
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    if(!napaka2){
      vrniStranke(function(nap1, stranke) {
        vrniRacune(function(nap2, racuni) {
      ...
      vrniStranke(function(nap1, stranke) {
        vrniRacune(function(nap2, racuni) {
          odgovor.render('prijava', {sporocilo: "Prišlo je do napake pri registraciji nove stranke", seznamStrank: stranke, seznamRacunov: racuni});  
        }) 
      });
    }
...
streznik.post('/stranka', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    zahteva.session.SejaTece = true;
    zahteva.session.polja = polja;
    odgovor.redirect('/')
  });
})
...
streznik.post('/odjava', function(zahteva, odgovor) {
   zahteva.session.destroy(function(err){
     if(err){
       console.log(err);
     }else{
       odgovor.redirect('/prijava');
